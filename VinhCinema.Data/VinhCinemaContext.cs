...
using VinhCinema.Data.Configurations;
using VinhCinema.Entities;

namespace VinhCinema.Data
{
    public class VinhCinemaContext: DbContext
    {
        public VinhCinemaContext(): base("VinhCinemaConnection")
        {
            Database.SetInitializer<VinhCinemaContext>(null);
        }
